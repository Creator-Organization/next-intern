...
const internshipDetails: InternshipDetails = {
    id: 1,
...
const ApplicationPage: FC<ApplicationPageProps> = ({ params }) => {
    ...
    const [domainKnowledge, setDomainKnowledge] = useState<number>(5);
    const [skillKnowledge, setSkillKnowledge] = useState<number>(5);
                            ...
                            <div className="bg-white p-8 rounded-lg shadow-md sticky top-24">
                                {isSubmitted ? (
                                    <div className="text-center">
                                        ...
                                        <a href="/student" className="mt-6 inline-block bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-colors">
                                            Back to Dashboard
                                        </a>
                                    </div>
                                ) : (
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-4">
                                    <input type="range" min="1" max="10" value={domainKnowledge} onChange={(e) => setDomainKnowledge(Number(e.target.value))} className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer" />
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-4">
                                    <input type="range" min="1" max="10" value={skillKnowledge} onChange={(e) => setSkillKnowledge(Number(e.target.value))} className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer" />
