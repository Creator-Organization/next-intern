    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6">
          ...
          <p className="text-gray-600">Communicate with companies about opportunities</p>
        </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-blue-700">
                  All communication must happen through this platform. Sharing contact information or moving conversations off-platform violates our terms of service.
                </p>
              </div>
            </div>
          </CardContent>
                  ...
                  filteredConversations.map((conversation) => (
                    <button
                      ...
                      className={`w-full p-4 flex items-start gap-3 hover:bg-white transition-colors border-b border-gray-100 text-left ${
                        selectedConversation?.userId === conversation.userId ? 'bg-white border-l-4 border-l-primary-500' : ''
                      }`}
                    >
                        ...
                        <div className="flex items-center justify-between mb-1">
                          <div className="flex items-center gap-2">
                            <span className="font-semibold text-gray-900 text-sm truncate">
                              {conversation.companyName || conversation.userName}
                            </span>
                      ...
                      <div>
                        <div className="flex items-center gap-2">
                          <h3 className="font-semibold text-gray-900">
                            {selectedConversation.companyName || selectedConversation.userName}
                          </h3>
